...
public class InvestService {
	 ...
	 * @return
	 */
	public InvRecord acc(InvRecord invRecord){
		return invRecordMapper.acc(invRecord);
	}
	/**
	 * 待收本金和利润
	 * @param invRecord
	 * @return
	 */
	public InvRecord dueIn(InvRecord invRecord){
		return invRecordMapper.dueIn(invRecord);
	}
}
