  ...
  <div class="w1200 personal">
    ...
    <div id="personal-left" class="personal-left">
      <ul>
        ...
        <li><span><a href="${ctx }/userInFo/userInfoToUpdate?id=${user_info.id}"><i class="dot dot03"></i>充值</a></span></li>
    ...
    <div class="personal-main">
      <div class="personal-pay">
        ...
        <div class="quick-pay-wrap">
          ...
          <form id="form" name="form" method="post" action="${ctx}/userInFo/userInfoToUpdate" >
