...
<body>
	...
	<div class="main-container" id="main-container">
		<jsp:include page="/menu.jsp">
			<jsp:param value="loan-loansubmit" name="menu" />
		</jsp:include>
											...
											<td>
												<div
													...
													<a class="blue"
														...
														data-target="#submitLoan${loan.id}" title="提交审核"> <i
														class="icon-check bigger-130"></i>
													</a>
													

													<div class="modal fade" tabindex="-1" role="dialog"
														id="submitLoan${loan.id}">
														<div class="modal-dialog" role="document">
															<form action="${ctx}/loan/submitloan" method="post">
